...
public class SignatureCreate extends View {
    ...
    public void save(View v) {
        ...
        try {
            // Output the file
            FileOutputStream mFileOutStream = new FileOutputStream(createPath());
            v.draw(canvas);
    ...
    public String createPath(){
        ...
        String DIRECTORY = Environment.getExternalStorageDirectory().getPath() + "/Signatures_canvas/";
        makeDirt(DIRECTORY);
    ...
    private void makeDirt(String DIRECTORY) {
